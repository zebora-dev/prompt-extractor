...
def build_profile(index: int, email: str) -> None:
    ...
    profile_dir = Path(f"/tmp/chatgpt-profile-build-{index}")
    ...
    if not chrome_bin:
        raise FileNotFoundError(
            "Could not find Google Chrome. Install it or set the path manually."
        )
    ...
    print()
    print("─" * 60)
    print(f"  Chrome has opened at chatgpt.com")
